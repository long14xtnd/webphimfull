...
<head>
    ...
    <link rel="shortcut icon"
          href="{{ url('public/hailongdev1.png') }}"
          type="image/x-icon"/>
    ...
    <style>#header .site-title {
            background: url('http://localhost/webphimfull/public/hailongdev1.png') no-repeat top left;
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0" nonce="iXIm65BZ"></script>
<header id="header">
    <div class="container">
        <div class="row" id="headwrap">
                        ...
                        <div class="form-group form-timkiem">
                            <div class="input-group col-xs-12">
                                <form action="{{route('tim-kiem')}}" method="GET">
                                    <input style="position: relative" type="text" name="search" id="timkiem"
                                           class="form-control"
                                           placeholder="Tìm kiếm phim..." autocomplete="off"><i
            ...
            <div class="col-md-4 hidden-xs">
                <div id="get-bookmark" class="box-shadow"><i
                        class="fa-solid fa-bookmark"></i><span> Bookmarks</span><span
            ...
            <div class="widget about col-xs-12 col-sm-4 col-md-4">
                <div class="footer-logo">
                    <img class="img-responsive"
                         src="{{ url('public/hailongdev1.png') }}"
                         alt="Phim hay 2021- Xem phim hay nhất"/>
                </div>
                Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                               data-cfemail="longdoan14xtnd@gmail.com">longdoan14xtnd@gmail.com-0859128666</a>
            </div>
...
<script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v13.0&appId=6125793717446054&autoLogAppEvents=1"
        nonce="LGtRA0Ug"></script>
                ...
                $.getJSON("<?php echo $baseUrl; ?>/public/json/movies.json",function(data){
                    $.each(data, function(key, value){
                        if (value.title.search(expression) != -1){
                            ...
                            var id = value.id
                            console.log(slug,id)
                            $('#result').append('<li class="list-group-item" style="cursor:pointer"><a href="/webphimfull/phim/' + value.slug + '.m' + value.id + '.html' + '"><img height="40" width="40" src="<?php echo $baseUrl; ?>/public/uploads/movie/'+value.image+'"">  '+value.title+'</a><br/> | <span>'+value.description+'</span></li>');
                        }
                    });
                })
            }else{
